...
const DEFAULT_PROPERTY_TYPE = 'flat';
...
export {
  ...
  ROOM_VAL_MESSAGES, MAP_FILTER_DISABLED, AD_FORM_DISABLED, CENTER_MAP_POSITION, MAIN_PIN_ICON_URL, OFFER_PIN_ICON_URL, REQUEST_URL,
  ...
  DEFAULT_IMAGE_PLACEHOLDER, MESSAGE_SEND_ERROR, MESSAGE_GET_ERROR, MAX_PROPERTY_NUMBER, RERENDER_DELAY, PROPERTY_PRICE_HIGH,
  PROPERTY_PRICE_LOW, DEFAULT_PROPERTY_TYPE
};
